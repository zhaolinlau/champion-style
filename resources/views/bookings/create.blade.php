				...
				<form class="row" method="POST" action="{{ route('bookings.store') }}">
					...
					<div class="col-sm-12 col-lg-6 mt-3">
						...
						<select name="branch" id="branch" required>
							...
							<option value="HQ PEKAN">HQ PEKAN</option>
							<option value="TAMAN MENTIGA PEKAN">TAMAN MENTIGA PEKAN</option>
							<option value="TAMAN TAS KUANTAN">TAMAN TAS KUANTAN</option>
							<option value="SUNGAI SOI KUANTAN">SUNGAI SOI KUANTAN</option>
							<option value="KG KEMPADANG KUANTAN">KG KEMPADANG KUANTAN</option>
						</select><br><br>
