    ...
    <div class="container">
        <div class="row d-flex align-items-center vh-100">
            <div class="col-sm-12 col-lg-8">
                ...
                <h5>
                    Discover expert haircuts, classic shaves, and personalized grooming services in a welcoming atmosphere
                    at Classic
                    Cuts Barbershop. Our skilled barbers blend tradition with modern style to give you the perfect look
                    every time.
                </h5>
                ...
                <div class="row gap-5 d-flex justify-content-center">
                    ...
                    <div class="col-sm-12 col-lg-3 rounded bg-primary-subtle px-3">
                        <img class="img-fluid rounded-3 mt-3"
                            src="{{ asset('img/408142901_922358702733857_6998792124864022871_n.jpg') }}"
                    ...
                    <div class="col-sm-12 col-lg-3 rounded bg-primary-subtle px-3">
                        <img class="img-fluid rounded-3 mt-3"
                            src="{{ asset('img/408101830_922358712733856_9156578562392528642_n.jpg') }}"
                    ...
                    <div class="col-sm-12 col-lg-3 rounded bg-primary-subtle px-3">
                        <img class="img-fluid rounded-3 mt-3"
                            src="{{ asset('img/408106718_922358839400510_2836777686269972667_n.jpg') }}"
        ...
        <div class="row mt-5 pt-5">
            <div class="col-sm-6 col-lg-3">
                <img src="{{ asset('img/woocommerce-placeholder-600x600.png') }}" alt="woocommerce-placeholder-600x600.png"
                    class="img-fluid">
                <p>Uncategorized</p>
                <h5><b>Product 1</b></h5>
                <div>
        ...
        <div class="row mt-5 pt-5">
            <div class="col-lg-6 col-sm-12">
                <img class="img-fluid" style="max-width: 544px"
                    src="{{ asset('img/433486675_993947515574975_6322663603438893601_n.jpg') }}"
            ...
            <div class="col-lg-6 col-sm-12 d-flex align-items-center">
                <div class="row">
                    ...
                    <div class="col-12 mt-4">
                        <p>
                            At Champion Style Barbershop, we pride ourselves on offering more than just a haircut; we
                            provide an experience
                            steeped in tradition and tailored to the modern man. Established with a passion for the art of
                            barbering, our shop
                            blends classic techniques with contemporary trends, ensuring every client leaves looking and
                            feeling their best.
                        </p>
                    </div>
        ...
        <div class="row mt-5 pt-5">
            ...
            <div class="col-12">
                <h1 class="fw-bold mt-3">
                    CLIENT FEEDBACK AND REVIEWS <i class="bi bi-pencil-square" data-bs-toggle="modal"
                        data-bs-target="#feedback" style="cursor: pointer;"></i>
                </h1>
            </div>
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            <form id="reviewform" class="mb-3" action="{{ route('submitRating') }}" method="POST">
                                ...
                                <textarea type="text" class="form-control" id="review" name="review" style="border-radius: 10px;"></textarea>
                                <button type="submit" class="btn mt-4"
                                    style="background-color: #a97c2a !important; color: #ffffff; border-radius: 15%"><i
                                        class="bi bi-image"></i></button>
                                <div class="mt-4">
                                    <button type="button" class="btn"
                                        style="background-color: #b4b4b4 !important; color: #ffffff; border-radius: 10px; width: 15%"
                                        data-bs-dismiss="modal">Cancel</button>
                                    <button type="submit" class="btn"
                                        style="background-color: #a97c2a !important; color: #ffffff; border-radius: 10px; width: 15%">Submit</button>
                                </div>
                            </form>
                        </div>
                    </div>
            ...
            <div class="col-12">
                <div class="row gap-5 d-flex justify-content-center">
                    @foreach ($ratings as $rating)
                        <div class="col-sm-12 col-lg-3 bg-primary-subtle rounded d-flex align-items-center"
                            style="height: 175px">
                            <div>
                                <p><b>{{ $rating->name }}</b></p>
        ...
        <div class="row mt-5 pt-5 mb-5">
            ...
            <div class="col-lg-7 col-sm-12 mt-3">
                <p>
                    Ready for a fresh new look or just need a trim? Don't wait! Schedule your appointment at Champion Style
                    today and
                    experience top-notch grooming services from our skilled barbers. Click the button below to book your
                    slot and enjoy
                    a
                    personalized grooming experience in a welcoming atmosphere. Your perfect style is just an appointment
                    away!
                </p>
